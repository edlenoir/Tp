...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Bonjour et bienvenue dans le systeme de création de personnage");
		System.out.println("Voulez vous créer une équipe");
		System.out.println("Veuillez écrire true pour Oui ou false pour Non");
		...
		for(int i =1 ; i <= nbEquipe; i++) {
			...
			case "créer":
				...
				System.out.println("Voilà votre classe " + Nomclasse + " est créée ");
